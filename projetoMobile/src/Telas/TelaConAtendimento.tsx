...
import { ConAtendimentoProps } from "../navigation/HomeNavigator";
...
const TelaConAtendimento = ({ navigation, route }: ConAtendimentoProps) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.titulo}>Lista de Atendimento</Text>
            <FlatList
                data={atendimento}
                renderItem={(info) =>
                    <ItemNota numero={info.index} atendimento={info.item} onAlterar={alterarCliente} onDeletar={deletarCliente} />}>
            </FlatList>
            <Pressable
